...
if (isset($_POST['edit'])) {
    ...
    $sql = "UPDATE blogs SET blog_title= '$title', blog_content = '$content' WHERE blog_id = $id";
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="title" class="form-control border" id="exampleFormControlInput1" style="padding-left: 20px;"
              value="<?php echo $data['blog_title']; ?>">
            </div>
            <div>
              <label for="formFileLg" class="form-label">Ảnh bài viết</label>
              <input class="form-control border form-control-lg" id="formFileLg" type="file" name="image1" value="<?php echo $data['blog_image_main']; ?>">
            </div> <br>
            <div class="mb-3">
              <label for="exampleFormControlInput1" class="form-label">Ngày tạo</label>
              <input type="text" class="form-control border" id="exampleFormControlInput1" name="" style="padding-left: 20px;"
              value="<?php echo $data['blog_created_at']; ?>">
            </div>
            <div class="mb-3">
              <label for="exampleFormControlInput1" class="form-label">Ngày cập nhập</label>
              <input type="text" class="form-control border" id="exampleFormControlInput1" name="update" style="padding-left: 20px;"
              value="<?php echo $data['blog_update_at']; ?>">
            </div>
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label">Nội dung bài viết</label>
              <textarea class="form-control border" id="exampleFormControlTextarea1" rows="10" name="content" style="padding-left: 20px;"><?php echo $data['blog_content']; ?></textarea>
            </div>
